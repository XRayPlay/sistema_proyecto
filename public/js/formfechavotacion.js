...
const expresiones = {
    ...
    fechavotacion: /^\d{2,4}\-\d{1,2}\-\d{1,2}$/
...
const validarFormulario = (e) => {
    switch (e.target.name) {
        ...
        case "fechavotacion":
            validarcampo(expresiones.fechavotacion, e.target, 'fechavotacion');
        break;
    }
}
...
selects.forEach((select) => {
    ...
    select.addEventListener('keyup', validarFormularioS);
})

formulario.addEventListener('submit', (e) => {

    if(campos.fechavotacion && campos.comunidad){
